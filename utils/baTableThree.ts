...
import type { baTableApi3 } from '/@/api/common'
...
export default class baTable {
    ...
    constructor(api: baTableApi3, table: BaTable, form: BaTableForm = {}, before: BaTableBefore = {}, after: BaTableAfter = {}) {
        this.api = api
