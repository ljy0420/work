<template>
    <el-header v-if="!navTabs.state.tabFullScreen" class="layout-header">
        <component :is="BasicNavBar"></component>
    </el-header>
</template>
<script setup lang="ts">
import { useConfig } from '/@/stores/config'
import { useNavTabs } from '/@/stores/navTabs'
import BasicNavBar from '/@/layouts/backend/components/navBar/basic.vue'
...
defineOptions({
    name: 'layout/header',
    components: { BasicNavBar, DefaultNavBar, ClassicNavBar, StreamlineNavBar, DoubleNavBar },
})
