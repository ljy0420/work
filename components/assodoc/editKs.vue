<template>
    <!-- 对话框表单 -->
    <el-dialog
        class="ba-operate-dialog yzxmf-edit"
        ...
        >
            ...
            >
                ...
                <el-form-item prop="KSBM" label="科室编码">
                    <el-select v-model="baTable.form.items!.KSBM" placeholder="请选择科室编码" clearable style="width: 100%">
                        <el-option v-for="opt in state.sjData" :key="opt.KSBM" :label="opt.KSMC" :value="opt.KSBM"></el-option>
                    </el-select>
                </el-form-item>
...
import type baTableClass from '/@/utils/baTableThree'
import type { FormInstance, FormItemRule } from 'element-plus'
import { getPymWbm } from '/@/api/common'

const prop = defineProps(['ksList', 'rowBm'])
