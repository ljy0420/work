<template>
    ...
    <div v-bind="$attrs" class="table-header ba-scroll-style">
        ...
        <el-tooltip v-if="props.buttons.includes('refresh')" :content="t('Refresh')" placement="top">
            <el-button v-blur @click="onAction('refresh', { loading: true })" style="width: 32px;height: 32px;" class="table-header-operate" type="info">
        ...
        <div class="table-search">
            ...
            <el-select
                ...
                @change="debounce(onSearchInput, 500)()" 
                v-if="props.buttons.includes('yxzt')">
                    <el-option
...
const toggleComSearch = () => {
    ...
    if(!baTable.table.showComSearch) {
