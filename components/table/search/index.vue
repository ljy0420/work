                ...
                <el-row>
                                ...
                                <div class="com-search-col">
                                    ...
                                    <div class="com-search-col-input">
                                        ...
                                        <component
                                            ...
                                            :renderRow="item"
                                            :renderField="item.filterName!"
                                            :renderValue="baTable.comSearch.form[item.filterName!]"
                                        />
                                        <!-- 自定义渲染-slot -->
                                ...
                                <div class="com-search-col">
                                    ...
                                    <div class="com-search-col-input-range w83">
                                        <el-date-picker
                                            ...
                                            v-model="baTable.comSearch.form[item.filterName!]"
                                            :default-value="baTable.comSearch.form[item.filterName! + '-default'] ? baTable.comSearch.form[item.filterName! + '-default']:[new Date(), new Date()]"
                                ...
                                <div class="com-search-col">
                                    ...
                                    <div v-if="item.operator == 'RANGE' || item.operator == 'NOT RANGE'" class="com-search-col-input-range">
                                        <el-input
                                            ...
                                            type="string"
                                            v-model="baTable.comSearch.form[item.filterName! + '-start']"
                                            :clearable="true"
                                        ></el-input>
                                        ...
                                        <el-input
                                            :placeholder="item.operatorPlaceholder"
                                            type="string"
                                            v-model="baTable.comSearch.form[item.filterName! + '-end']"
                                            :clearable="true"
                                        ></el-input>
                                    </div>
                                    <!-- 是否 [NOT] NULL -->
                                    <div v-else-if="item.operator == 'NULL' || item.operator == 'NOT NULL'" class="com-search-col-input">
                                        <el-checkbox v-model="baTable.comSearch.form[item.filterName!]" :label="item.operator" size="large"></el-checkbox>
                                    </div>
                                    <div v-else-if="item.operator" class="com-search-col-input">
                                        ...
                                        <el-date-picker
                                            ...
                                            :value-format="item.comSearchRender == 'date' ? 'YYYY-MM-DD' : 'YYYY-MM-DD HH:mm:ss'"
                                            :placeholder="item.operatorPlaceholder"
                                            :default-value="baTable.comSearch.form[item.filterName! + '-default'] ? baTable.comSearch.form[item.filterName! + '-default']:new Date()"
                                            :teleported="false"
                                        />
                                        ...
                                        <el-select
                                            ...
                                            :clearable="true"
                                        >
                                            <el-option v-for="(opt, okey) in item.replaceValue" :key="item.filterName! + okey" :label="opt" :value="okey" />
                                        </el-select>
                    ...
                    <el-col :xs="24" :sm="6">
                        <div class="com-search-col pl-20">
                            <el-button round v-blur @click="onComSearch" type="primary">{{ $t('Search') }}</el-button>
                            <el-button round @click="onResetForm()">{{ $t('Reset') }}</el-button>
                        </div>
                    </el-col>
                </el-row>
            </el-form>
...
const onComSearch = () => {
    ...
    for (const key in baTable.comSearch.form) {
        ...
        if (val) {
            ...
            // if(baTable.table.filter![key]) {
            //     baTable.table.filter![key] = val
            // }
        }
    }
