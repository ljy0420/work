 ...
 * @returns
 */
export const ykPddEdit = (data: any) => {
    return createAxios({
        url: '/api/v1/ykzx/pdd/edit',
        method: 'POST',
        data,
    })
}
 ...
 * @returns
 */
export const ykPddCreate = (data: any) => {
    return createAxios({
        url: '/api/v1/ykzx/pdd/add',
        method: 'POST',
        data,
    })
}
