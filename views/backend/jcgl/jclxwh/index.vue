<template>
    <div class="default-main ba-table-box">
        ...
        <Table :pagination="false" height="calc(100vh - 200px)" />
...
const baTable = new baTableClass(
    new baTableApi('/api/v1/xtsjwh/yzxmjclx/'),
    {
        column: [
            { type: 'selection', align: 'center', operator: false },
            // { label: '机构编码', prop: 'JGBM', align: 'left', width: 130 },
            { label: '编码', prop: 'BM', align: 'left', width: 200 },
            { label: '名称', prop: 'MC', align: 'left', width: 130 },
            { label: '拼音码', prop: 'PYM', align: 'left', width: 100 },
            { label: '建病案', prop: 'JBA', align: 'left', width: 200, render: 'switch' },
            {
                label: '操作',
                align: 'left',
                width: '100',
        ...
        dblClickNotEditColumn: [undefined, 'JBA'],
