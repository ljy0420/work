    ...
    >
        <template #header>
            <div class="title" v-drag="['.ba-operate-dialog', '.el-dialog__header']" v-zoom="'.ba-operate-dialog'">
                {{ baTable.form.operate == 'Add' ? '报销类别-新增' : '报销类别-修改' }}
            </div>
        </template>
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    <el-form-item prop="BXMC" label="报销名称">
                        <el-input
                            v-model="baTable.form.items!.BXMC"
                            type="string"
                            @change="mChange"
                            placeholder="请输入报销名称"
                        ></el-input>
                    </el-form-item>
                    <el-form-item prop="BXBM" label="报销编码">
                        <el-input
                            v-model="baTable.form.items!.BXBM"
                            type="string"
                            placeholder="请输入报销编码"
                        ></el-input>
                    </el-form-item>
                    ...
                    <el-form-item prop="BXBL" label="报销比例">
                        <el-input
                            v-model="baTable.form.items!.BXBL"
                            type="string"
                            placeholder="请输入报销比例"
                        ></el-input>
                    </el-form-item>
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    BXMC: [buildValidatorData({ name: 'required', message: '报销名称不能为空.' })],
})
