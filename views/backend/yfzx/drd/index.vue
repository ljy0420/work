<template>
    <div class="layout-box">
        ...
        <div class="table-item-top">
            ...
            <div class="export" @click="exportYkBtn('export')" :class="[currentradio ? 'btn' : 'current-btn']">
        ...
        >
            ...
            <el-table-column prop="LYYFBM" label="调出库房" align="center" width="100">
                <template #default="scope">
                    <span>{{ renderYfbm(scope.row.LYYFBM) }}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column fixed="right" label="操作" align="center" width="100">
                <template #default="{ row }">
                    <div class="table-item">
                        <div class="btn" @click="drdLokk(row)">
...
import { getDrdList, cxYfYk } from '/@/api/backend/yfzx/drd'
...
// 获取调出库房
const renderYfbm = (bm: string) => {
    let ret = bm
    ret = ykyfData.value.find((item: any) => item.BM == bm)?.MC
    return ret
}
// 获取申请人
...
// 查看调入单
const drdLokk = (row: any) => {
    router.push({
        path: '/admin/yfzx/drd/detail',
        query: {
            type: 'look',
            DJID: row.DJID,
            YFBM: formData.YFBM,
