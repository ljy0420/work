<template>
    <div class="layout-box">
        ...
        >
            ...
            <el-table-column prop="TKKS" label="退库科室" align="center" width="80"> </el-table-column>
            ...
            <el-table-column prop="YKCKDJH" label="引用出库单单据号" align="center" width="140"> </el-table-column>
            <el-table-column prop="GJZE" label="购进总额" align="center" width="90"> </el-table-column>
            <el-table-column prop="LSZE" label="零售总额" align="center" width="90"> </el-table-column>
...
import { getTkdList } from '/@/api/backend/yfzx/tkd'
