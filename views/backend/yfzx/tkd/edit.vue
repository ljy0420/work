    ...
    <div class="layout-box">
            ...
            <el-scrollbar>
                <el-form :model="formData" :inline="true" label-width="100px">
                    ...
                    <el-form-item prop="JSRBM" label="接收人">
                        <el-select filterable v-model="formData.JSRBM" :disabled="true" placeholder="请选择接收人" clearable
                            style="width: 100%">
                            <el-option v-for="opt in personnelIfon" :key="opt.RYBM" :label="opt.RYXM"
                                :value="opt.RYBM"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="申请部门" prop="KFBM">
                        <el-select filterable v-model="formData.KFBM" :disabled="true" placeholder="请选择"
                            style="width: 100%">
        ...
        <div class="yd-card-body">
            <el-table ref="tableref" :data="state.ykData" class="color-table"
                ...
                <el-table-column prop="YFKC" label="药房库存" align="center" width="90"></el-table-column>
...
import { getTkdDetail, getTkdList, cxYfYk } from '/@/api/backend/yfzx/tkd'
import useCurrentInstance from '/@/utils/useCurrentInstance'
import { useNavTabs } from '/@/stores/navTabs'
import { useRouter, useRoute } from 'vue-router'

defineOptions({
    name: 'yfzx/tkd/detail',
})
