        ...
        <div class="yd-card-body">
            ...
            >
                ...
                <el-table-column prop="" label="数量" align="center" width="350">
                    <el-table-column prop="ZMS" label="账面" align="center" width="100"></el-table-column>
                    ...
                    <el-table-column prop="SLYK" label="盈亏" align="center" width="100"></el-table-column>
                </el-table-column>
...
import { getPddMx, getPddList, scPdmx } from '/@/api/backend/yfzx/pdd'
