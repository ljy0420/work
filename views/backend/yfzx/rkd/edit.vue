    ...
    <div class="layout-box">
            ...
            <el-scrollbar>
                <el-form :model="formData" :inline="true" label-width="100px">
                    ...
                    <el-form-item prop="SHRQ" label="审核时间">
                        <el-date-picker v-model="formData.SHRQ" type="datetime" :disabled="true" placeholder="请选择审核日期"
                            style="width: 100%" />
                    </el-form-item>
                    ...
                    <el-form-item label="发货人" prop="FHRBM">
                        <el-select v-model="formData.FHRBM" placeholder="请选择" :disabled="true" clearable
                            style="width: 100%">
                            <el-option v-for="opt in personnelIfon" :key="opt.RYBM" :label="opt.RYXM"
                                :value="opt.RYBM"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item prop="SQRBM" label="申请人">
                        <el-select v-model="formData.SQRBM" placeholder="请选择" :disabled="true" clearable
                            style="width: 100%">
                            <el-option v-for="opt in personnelIfon" :key="opt.RYBM" :label="opt.RYXM"
                                :value="opt.RYBM"></el-option>
                        </el-select>
        ...
        <div class="yd-card-body">
            <el-table ref="tableref" :data="state.ykData" class="color-table"
                ...
                <el-table-column prop="SL" label="数量" align="center" width="60"></el-table-column>
                ...
                <el-table-column prop="HWMC" label="货位" align="center" width="100"></el-table-column>
                <el-table-column prop="GGKC" label="规格库存" align="center" width="90"></el-table-column>
                <el-table-column prop="PCKC" label="批次库存" align="center" width="90"></el-table-column>
...
import { getRkdDetail, getRkdList } from '/@/api/backend/yfzx/rkd'
import useCurrentInstance from '/@/utils/useCurrentInstance'
import { useNavTabs } from '/@/stores/navTabs'
import { useRouter, useRoute } from 'vue-router'

defineOptions({
    name: 'yfzx/rkd/detail',
})
