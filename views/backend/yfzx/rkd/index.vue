<template>
    <div class="layout-box">
        ...
        <div class="search-box">
            <el-form :model="formData" :inline="true" label-width="auto" class="zw-table-search">
                <el-form-item label="药房" label-width="40">
                    <el-select v-model="formData.YFBM" placeholder="请选择库房" clearable class="kf-select">
                ...
                <el-form-item>
                    <el-button type="primary" @click="getRkdsList">查询</el-button>
        ...
        >
            ...
            <el-table-column prop="LYKF" label="来源库房" align="center" width="80"> </el-table-column>
            ...
            <el-table-column prop="YFQLDJH" label="药房请领单据号" align="center" width="125"> </el-table-column>
            <el-table-column prop="YKCKDJH" label="药库出库单据号" align="center" width="125"> </el-table-column>
            <el-table-column prop="DJLX" label="单据类型" align="center" width="140">
                <template #default="{ row }">
                    {{ row.DJLX == 0 ? '普通' : row.DJLX == 1 ? '采购计划生成' : '阳关采购平台对接' }}
                </template>
            </el-table-column>
            <el-table-column prop="JYLX" label="交易类型" align="center" width="110">
                <template #default="{ row }">
            ...
            <el-table-column fixed="right" label="操作" align="center" width="80">
                <template #default="{ row }">
                    <div class="table-item">
                        <div class="btn" @click="yfRkdLook(row)">
...
import { getRkdList } from '/@/api/backend/yfzx/rkd'
...
const exportYkBtn = () => {
    export_table_to_excel('#exportTable', '入库单')
}
...
// 调入单列表
const getRkdsList = async () => {
    const res = await getRkdList({ agrs: { ...formData } })
