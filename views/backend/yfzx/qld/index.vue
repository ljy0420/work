    ...
    <div class="layout-box">
        ...
        <div class="search-box">
            <el-form :model="formData" :inline="true" label-width="auto" class="zw-table-search">
                ...
                <el-form-item>
                    <el-button type="primary" @click="getQldsList">查询</el-button>
        ...
        >
            ...
            <el-table-column prop="CKKF" label="出库库房" align="center" width="80"> </el-table-column>
            ...
            <el-table-column prop="SQRXM" label="申请人" align="center" width="80"> </el-table-column>
            ...
            <el-table-column prop="FYRXM" label="发药人" align="center" width="80"> </el-table-column>
            <el-table-column prop="FYSJ" label="发药时间" align="center" width="120"> </el-table-column>
            <el-table-column prop="CKDJH" label="出库单据号" align="center" width="120"> </el-table-column>
            <el-table-column prop="RKDJH" label="药房入库单据号" align="center" width="120"> </el-table-column>
            ...
            <el-table-column fixed="right" label="操作" align="center" width="180">
                <template #default="{ row }">
                    <div class="table-item">
                        <div class="btn" @click="qldLokk(row)">
                            <Icon name="local-look" style="color: #4ca7f9" class="local-icon" />
                            <div>查看</div>
                        </div>
                        <div class="btn" v-if="row.ZT == 1" @click="qldEdit(row)">
...
import { getQldList, yfQldEdit } from '/@/api/backend/yfzx/qld'
...
// 请领单列表
const getQldsList = async () => {
    const res = await getQldList({ agrs: { ...formData } })
...
const exportYfBtn = () => {
    export_table_to_excel('#exportTable', '请领单')
}
