    ...
    <div class="layout-box">
            ...
            <el-scrollbar>
                <el-form :model="formData" :inline="true" label-width="100px" ref="ruleFormRef" :rules="rules">
                    ...
                    <el-form-item prop="SQR" label="申请人">
                        <el-input v-model="formData.SQR" type="string" :disabled="true" />
                    </el-form-item>
        ...
        <div class="yd-card-body">
            <el-table ref="tableref" :data="state.ykData" class="color-table"
                ...
                <el-table-column prop="SLXX" label="数量" align="center" width="120">
                    <el-table-column prop="DDWSL" label="大单位数量" align="center" width="85"></el-table-column>
                    <el-table-column prop="XDWSL" label="小单位数量" align="center" width="85"></el-table-column>
                </el-table-column>
...
import { getSydDetail, getSydList } from '/@/api/backend/yfzx/syd'
