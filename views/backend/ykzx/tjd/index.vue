<template>
    <div class="layout-box">
        ...
        <div class="search-box">
            <el-form :model="formData" :inline="true" label-width="auto" class="zw-table-search">
                <el-form-item label="库房" label-width="40">
                    <el-select v-model="formData.KFBM" placeholder="请选择" clearable class="kf-select">
                ...
                <el-form-item>
                    <el-button type="primary" @click="getTjdsList">查询</el-button>
        ...
        >
            ...
            <el-table-column prop="TJKF" label="调价库房" align="center" width="90"> </el-table-column>
            <el-table-column prop="KDRQ" label="开单时间" align="center" width="155"> </el-table-column>
            <el-table-column prop="KDRXM" label="开单人" align="center" width="100"> </el-table-column>
            <el-table-column prop="SQR" label="物价员" align="center" width="80"> </el-table-column>
            ...
            <el-table-column prop="DJLX" label="单据类型" align="center" width="120">
                <template #default="{ row }">
                    {{ row.DJLX == 0 ? '普通' : row.DJLX == 1 ? '采购计划生成' : '阳关采购平台对接' }}
                </template>
            </el-table-column>
            <el-table-column prop="JYLX" label="交易类型" align="center" width="100">
                <template #default="{ row }">
                    {{ row.JYLX == 0 ? '手工输入' : row.JYLX == 1 ? '系统生成' : '外部导入' }}
                </template>
            </el-table-column>
            <el-table-column label="原价" align="center" width="150">
                <el-table-column prop="YGJZE" label="购进总额" align="center" width="90"> </el-table-column>
                <el-table-column prop="YLSZE" label="零售总额" align="center" width="90"> </el-table-column>
            </el-table-column>
            <el-table-column label="新价" align="center" width="150">
                <el-table-column prop="XGJZE" label="购进总额" align="center" width="90"> </el-table-column>
                <el-table-column prop="XLSZE" label="零售总额" align="center" width="90"> </el-table-column>
            </el-table-column>
            <el-table-column label="盈亏" align="center" width="150">
                <el-table-column prop="JHJYK" label="购进总额" align="center" width="90"> </el-table-column>
                <el-table-column prop="LSJYK" label="零售总额" align="center" width="90"> </el-table-column>
            </el-table-column>
            ...
            <el-table-column fixed="right" label="操作" align="center" width="180">
                <template #default="{ row }">
                    <div class="table-item">
                        <div class="btn" @click="tjdLokk(row)">
                            <Icon name="local-look" style="color: #4ca7f9" class="local-icon" />
                            <div>查看</div>
                        </div>
                        <div class="btn" v-if="row.ZT == 1" @click="tjdEdit(row)">
...
import { getTjdList, ykTjdEdit } from '/@/api/backend/yk/tjd'
...
// 调价单列表
const getTjdsList = async () => {
    const res = await getTjdList({ agrs: { ...formData } })
...
const exportYkBtn = () => {
    export_table_to_excel('#exportTable', '调价单')
}
