            ...
            <el-scrollbar class="ba-table-form-scrollbar">
                <el-form :model="formData" :inline="true" label-width="100px" ref="ruleFormRef" :rules="rules">
                    <el-form-item prop="KDRQ" label="开单时间">
                        <el-date-picker v-model="formData.KDRQ" type="datetime" placeholder="请选择开单时间" style="width: 100%" />
                    </el-form-item>
                    ...
                    <el-form-item prop="ZXSJ" label="执行时间">
                        <el-date-picker v-model="formData.ZXSJ" type="datetime" placeholder="请选择执行时间" style="width: 100%" class="ZXSJ" />
                    </el-form-item>
