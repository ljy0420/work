    ...
    <div class="layout-box">
        <div class="form-top">
            <el-scrollbar>
                <el-form :model="formData" :inline="true" label-width="100px">
                    ...
                    <el-form-item label="调出库房" prop="JSKFBM">
                        <el-select filterable v-model="formData.LYKFBM" placeholder="请选择" :disabled="true"
                            style="width: 100%">
        ...
        <el-form :model="formData" :inline="true" label-width="90px" class="bottom-form">
            ...
            <el-form-item prop="DCDJH" label="来源单据号">
                <el-input v-model="formData.DCDJH" type="string" :disabled="true" placeholder="请输入" />
            </el-form-item>
        </el-form>
        <!-- 按钮部分 -->
...
import { getDrdMx, cxYfYk, getDrdList } from '/@/api/backend/yk/drd'
...
const getlook = async () => {
    ...
    formData.LYKFBM = r.data[0].LYKFBM
