            ...
            <el-form :model="state" :rules="mxRules" ref="mxFormRef">
                ...
                >
                    ...
                    <el-table-column prop="SL" label="调出数量" align="center" width="80">
                        <template #default="scope">
                            <el-form-item v-if="receiptType !== 'look'" :prop="'ykData.' + scope.$index + '.SL'" :rules="mxRules.SL">
                                <el-input
...
const handleKeyDown3 = () => {
    let ele = ruleFormRef.value.$el.querySelector(`.JSKFBM .el-input__inner`)
    if (ele) {
        ele.focus()
    }
}
