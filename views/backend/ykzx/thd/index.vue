    ...
    <div class="layout-box">
        ...
        <div class="search-box">
            <el-form :model="formData" :inline="true" label-width="auto" class="zw-table-search">
                ...
                <el-form-item>
                    <el-button type="primary" @click="getThdsList">查询</el-button>
        ...
        <div class="table-item-top">
            <el-dropdown>
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item @click="thdCreate()">手工录入</el-dropdown-item>
                        <el-dropdown-item @click="ykjhdBtnType()">根据进货单生成</el-dropdown-item>
                    </el-dropdown-menu>
                </template>
            </el-dropdown>
        ...
        >
            ...
            <el-table-column prop="GYSMC" label="供应商" align="center" width="200"> </el-table-column>
            ...
            <el-table-column prop="FPHM" label="发票号" align="center" width="170"> </el-table-column>
            <el-table-column prop="FPSJ" label="发票时间" align="center" width="160"> </el-table-column>
            ...
            <el-table-column fixed="right" label="操作" align="center" width="200">
                <template #default="{ row }">
                    <div class="table-item">
                        <div class="btn" @click="thdLokk(row)">
                            <Icon name="local-look" style="color: #4ca7f9" class="local-icon" />
                            <div>查看</div>
                        </div>
                        <div class="btn" v-if="row.ZT == 1" @click="thdEdit(row)">
        ...
        <JhdEdit
            ...
            :jhddialogVisible="jhddialogVisible"
        ></JhdEdit>
    </div>
</template>
...
import { getThdList, ykThdEdit } from '/@/api/backend/yk/thd'
...
const exportYkBtn = () => {
    export_table_to_excel('#exportTable', '退货单')
}
...
const lookDetail = async (row) => {
    djid.value = row.DJID
    djh.value = row.DJH
    const res = await getJhdInfo({ agrs: { DJH: row.DJH, DJID: row.DJID, KFBM: formData.KFBM } })
...
// 退货单列表
const getThdsList = async () => {
    const res = await getThdList({ agrs: { ...formData } })
...
const getJhdsList = async () => {
    const res = await getJhdList({ agrs: { ...dialogformData } })
