        ...
        <div class="form-top">
            <el-form :model="formData" :inline="true" label-width="100px" :rules="rules" ref="ruleFormRef">
                ...
                <el-form-item prop="JSRBM" label="接收人">
                    <el-select filterable v-model="formData.JSRBM" placeholder="请选择接收人"
                ...
                <el-form-item label="申请部门" prop="KSBM">
                    <el-select filterable v-model="formData.KSBM" placeholder="请选择"
                ...
                <el-form-item prop="QLR" label="申请人">
                    <el-select v-model="formData.QLR" clearable filterable
                        :disabled="examineTime != undefined" style="width: 100%"
...
const tableRowClassName = ({ row }: { row: any }) => {
    if (row.RYXM == formData.QLR) {
        return 'bottom-row'
    }
}

const handleCellClick = (row: any) => {
    formData.QLR = row.RYXM
}

const handleInputClick = () => {
    isElelect.value = true
}
