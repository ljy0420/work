    ...
    <div class="layout-box">
            ...
            <el-scrollbar>
                <el-form :model="formData" :inline="true" label-width="100px" ref="ruleFormRef" :rules="rules">
                    ...
                    <el-form-item label="请领部门" prop="KSBM">
                        <el-select filterable v-model="formData.KSBM" placeholder="请选择" clearable style="width: 100%"
                            class="QLBM" @keyup.enter="handleKeyDown5($event, 'QLR')">
                            <el-option v-for="opt in ykyfData" :key="opt.BM" :label="opt.MC" :value="opt.BM"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item prop="QLR" label="请领人">
                        <el-select filterable v-model="formData.QLR" placeholder="请选择请领人" clearable style="width: 100%"
                            class="QLR" @keyup.enter="handleKeyDown5($event, 'PZRBM')">
                            <el-option v-for="opt in personnelIfon" :key="opt.RYBM" :label="opt.RYXM"
                                :value="opt.RYBM"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="批准人">
                        <el-select filterable v-model="formData.PZRBM" placeholder="请选择" clearable style="width: 100%"
                            class="PZRBM" @keyup.enter="handleKeyDown5($event, 'specs_frame')">
                            <el-option v-for="opt in personnelIfon" :key="opt.RYBM" :label="opt.RYXM"
                                :value="opt.RYBM"></el-option>
                        </el-select>
                    </el-form-item>
        ...
        <el-form :model="formData" :inline="true" label-width="90px" ref="ruleFormRefs" :rules="rules" class="bottom-form">
            ...
            <el-form-item label="发货人" prop="FHRBM">
                <el-select v-model="formData.FHRBM" placeholder="请选择发货人" clearable style="width: 100%">
