                ...
                <el-form :model="formData" :inline="true" label-width="100px" ref="ruleFormRef" :rules="rules">
                    <el-form-item prop="KDRQ" label="开单日期">
                        <el-date-picker
                            ...
                            type="datetime"
                            l
                            :disabled="receiptType == 'look' || examineTime != undefined"
                            placeholder="请选择开单日期"
                            style="width: 100%"
                        />
                    </el-form-item>
                    ...
                    <el-form-item label="请领部门" prop="KSBM">
                        <el-select
                            filterable
                            v-model="formData.KSBM"
                            placeholder="请选择"
                            :disabled="receiptType == 'look' || examineTime != undefined"
                            clearable
                            style="width: 100%"
                            class="QLBM"
                            @keyup.enter="handleKeyDown5($event, 'QLR')"
                        >
                ...
                <el-form :model="state" :rules="rules1" ref="ruleFormRef2">
                    ...
                    >
                        ...
                        <el-table-column prop="FYSL" label="库房数量" align="center" width="100">
                            <template #default="scope">
                                <el-form-item style="height: 15px" :prop="'ykData.' + scope.$index + '.FYSL'" :rules="rules1.FYSL">
                                    <el-input
                                        v-model.number="scope.row.FYSL"
                                        style="width: 100%"
                                        :disabled="!scope.row.isEdit || receiptType == 'look' || examineTime != undefined"
                                        oninput="value=value.replace(/[^\d]/g,'')"
                                        @change="slhandleChange(scope.row)"
                                        class="yk-FYSL"
                                        @keydown.enter="fyslhandleKeyDown($event, scope, 'yk-JBDWSL', 'yk-FYSL')"
                                    ></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="JBDWSL" label="基本单位数量" align="center" width="100">
                            <template #default="scope">
                                <el-form-item style="height: 15px" :prop="'ykData.' + scope.$index + '.JBDWSL'" :rules="rules1.JBDWSL">
                                    <el-input
                                        v-model.number="scope.row.JBDWSL"
                                        style="width: 100%"
                                        :disabled="!scope.row.isEdit || receiptType == 'look' || examineTime != undefined"
                                        oninput="value=value.replace(/[^\d]/g,'')"
                                        @change="JBDWSLhandleChange(scope.row)"
                                        class="yk-JBDWSL"
                                        @keydown.enter="jbdwslhandleKeyDown($event, scope, 'BZ', 'yk-JBDWSL')"
                                    ></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="" label="操作" width="150" fixed="right" align="center">
                            <template #default="scope">
                                <div style="display: flex; justify-content: space-around">
                                    <el-button
                                        v-if="receiptType == 'order' || JHDJHs != undefined"
                                        link
                                        v-blur
                                        type="primary"
                                        size="small"
