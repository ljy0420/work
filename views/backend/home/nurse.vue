    ...
    <div class="default-main index-container">
        <div class="banner">
            <el-row :gutter="20">
                ...
                <el-col :sm="12" :lg="6">
                    <div class="small-panel byzyrs">
                        <div class="title">本月住院人数</div>
                        <div class="content">
                            <div class="content-left">
                                <span id="file_number">236</span>
                            </div>
                        </div>
                    </div>
                </el-col>
                <el-col :sm="12" :lg="6">
                    <div class="small-panel bycyrs">
                        <div class="title">本月出院人数</div>
                        <div class="content">
                            <div class="content-left">
                                <span id="users_number">1367</span>
                            </div>
                ...
                <el-col :sm="12" :lg="6">
                    <div class="small-panel xtwhsj">
                        <div class="title">系统维护数据</div>
                        <div class="content">
                            <div class="content-left">
                                <span id="addons_number">368</span>
                            </div>
                            <div class="content-right">
                                <div class="compare-label">比上月</div>
...
.banner {
    ...
    .byzyrs {
        background: url(/@/assets/images/byzyrs-card-bg.png) no-repeat center center/cover;
        padding-left: 50px;
    ...
    .bycyrs {
        background: url(/@/assets/images/bycyrs-card-bg.png) no-repeat center center/cover;
        padding-left: 50px;
    ...
    .xtwhsj {
        background: url(/@/assets/images/xtwhsj-card-bg.png) no-repeat center center/cover;
        padding-left: 50px;
