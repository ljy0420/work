        ...
        <div class="cf-main">
                    ...
                    <el-dropdown>
                        ...
                        <template #dropdown>
                            <el-dropdown-menu @mouseenter="cancelHideTimer" @mouseleave="hideButton">
                                ...
                                <el-dropdown-item>
                                    <Icon name="local-withdraw" color="#59a7ff" class="menu-svg" />
                                    <span>撤回发送</span>
                                </el-dropdown-item>
                            </el-dropdown-menu>
                        </template>
            ...
            <div class="cf-items" v-show="state.cfInfo.isExpand">
                <el-table ref="cfRef" :data="state.cfInfo.items" highlight-current-row style="width: 100%">
                    <el-table-column prop="YZMC" label="药品名称" width="300">
                    ...
                    <el-table-column prop="JZ" label="脚注" width="200">
                        <template #default="scope">
                            <el-input
                    ...
                    <el-table-column prop="YL" label="用量" width="200">
                        <template #default="scope">
                            <el-input
