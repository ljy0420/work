        ...
        <div class="mz-home-content">
            <el-scrollbar v-loading="state.loading">
                ...
                <div class="mz-home-body">
                    <div class="mz-brxx">
                        <div class="item"><span>姓名：</span><span>{{ props.brxx.XM }}</span></div>
                        <div class="item"><span>性别：</span><span>{{ props.brxx.XB }}</span></div>
                        <div class="item"><span>出生日期：</span><span>{{ props.brxx.CSRQ }}</span></div>
                        <div class="item"><span>年龄：</span><span>{{ props.brxx.NL }}</span></div>
        ...
        <div class="mz-home-template">
            <el-scrollbar>
                ...
                <div class="template-list">
                    <div class="template-item" v-for="item in state.tpList" :key="item.BM">
                        <div class="title">{{ item.MBMC }}</div>
...
const state: {
    ...
    loading: false,
    tpList: [
        { BM: '01', MBMC: '模版1', MBMS: '主诉：参考文字参考文字参考文字参考文字参考文字参考文字' },
        { BM: '02', MBMC: '模版2', MBMS: '主诉：参考文字参考文字参考文字参考文字参考文字参考文字' },
        { BM: '03', MBMC: '模版3', MBMS: '主诉：参考文字参考文字参考文字参考文字参考文字参考文字' },
        { BM: '04', MBMC: '模版4', MBMS: '主诉：参考文字参考文字参考文字参考文字参考文字参考文字' },
        { BM: '05', MBMC: '模版5', MBMS: '主诉：参考文字参考文字参考文字参考文字参考文字参考文字' },
        { BM: '06', MBMC: '模版6', MBMS: '主诉：参考文字参考文字参考文字参考文字参考文字参考文字' }
    ]
})
